...
ALTER TABLE logins ADD CONSTRAINT PK_LOGINS PRIMARY KEY (user_id);

ALTER TABLE players ADD CONSTRAINT PK_PLAYERS PRIMARY KEY (p_name);

ALTER TABLE team ADD CONSTRAINT PK_TEAM PRIMARY KEY (t_name);

ALTER TABLE team ADD CONSTRAINT FK_logins_TO_team_1 FOREIGN KEY (user_id)
