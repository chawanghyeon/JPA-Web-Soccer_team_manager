  ...
  <body>
    <script>
      function playerUpdate() {
        axios
          .get('http://localhost/soccer_team_manager/player/update.jsp')
          .then((resData) => {
    ...
    <div class="container">
      <div class="card">
        ...
        <div class="info">
          ...
          <div class="purchase">
            <button onclick="playerUpdate()">수정하기</button>
            <button
              onclick="location.href='http://localhost/soccer_team_manager/soccerteam?command=deletePlayer'"
            >
              선수 삭제
            </button>
            <button
